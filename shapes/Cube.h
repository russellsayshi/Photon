...
public:
	...
	Cube(double x, double y, double z, double r) : center(Vec3(x, y, z)), radius(r) {
		planes[0] = Plane(1,0,0,x+r,y,z);
		planes[1] = Plane(1,0,0,x-r,y,z);
		planes[2] = Plane(0,1,0,x,y+r,z);
		planes[3] = Plane(0,1,0,x,y-r,z);
		planes[4] = Plane(0,0,1,x,y,z+r);
		planes[5] = Plane(0,0,1,x,y,z-r);
		// dx, dy, dz, x, y, z
	}
